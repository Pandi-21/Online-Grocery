...
from controllers.dashboard_controller import dashboard_stats, latest_orders

dashboard_bp = Blueprint("dashboard", __name__, url_prefix="/admin")

dashboard_bp.route("/dashboard-stats", methods=["GET"])(dashboard_stats)
dashboard_bp.route("/latest-orders", methods=["GET"])(latest_orders)
