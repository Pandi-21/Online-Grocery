    ...
    const fetchProducts = async () => {
      try {
        ...
        const res = await api.get(
          `/products?category=${category}&subcategory=${subcategory}&item=${item}`
        );
            ...
            {products.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <Link
                    to={`/${category}/${subcategory}/${item}/${id}`}
                    className="block"
                  >
                    <img
                  ...
                  {/* Price + Add/Qty */}
                  <div className="mt-4">
                    <p className="text-lg font-bold">${p.price}/lb</p>
