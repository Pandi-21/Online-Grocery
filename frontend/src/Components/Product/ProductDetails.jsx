...
//               <select value={color} onChange={(e) => setColor(e.target.value)} className="w-full border rounded-lg px-3 py-2">
//                 {product.colors?.map((c) => <option key={c}>{c}</option>)}
//               </select>
//             </div>
//             <div>
//               <label className="block text-sm font-medium mb-1">Quantity</label>
//               <select value={quantity} onChange={(e) => setQuantity(Number(e.target.value))} className="w-full border rounded-lg px-3 py-2">
...
//             <button onClick={handleAddToCart} className="flex items-center justify-center gap-2 bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600">
//               <FaShoppingCart /> Add to Cart
//             </button>
//             <button onClick={handleBuyNow} className="border border-green-500 text-green-500 px-6 py-3 rounded-lg hover:bg-green-100">
//               Buy Now
//             </button>
//           </div>
//         </div>
...
//             <button
//               key={tab}
//               className={`pb-2 capitalize ${activeTab === tab ? "text-green-600 border-b-2 border-green-600 font-semibold" : "text-gray-500"}`}
...
//             {product.specifications && Object.entries(product.specifications).map(([key, value], i) => <li key={i}><strong>{key}:</strong> {value}</li>)}
//           </ul>
//         )}
//         {activeTab === "reviews" && (
//           <div>
